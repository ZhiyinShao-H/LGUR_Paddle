...
def get_dataloader(opt):
    ...
    if opt.mode == 'train':
        ...
        dataloader = paddle.io.DataLoader(dataset, batch_size=opt.batch_size,
        ...
        img_dataloader = paddle.io.DataLoader(img_dataset, batch_size=opt.batch_size,
                                                 shuffle=False, drop_last=False, num_workers=3)

        txt_dataset = CUHKPEDE_txt_dateset(opt)

        txt_dataloader = paddle.io.DataLoader(txt_dataset, batch_size=opt.batch_size,
                                                 shuffle=False, drop_last=False, num_workers=3)
